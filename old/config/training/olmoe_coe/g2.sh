...
configs=(
    "fl-256epts-8topk-4iter-1lyr:256:8:4:1"
    ...
    # "lyr-m-64epts-6topk-1iter-6lyr:64:6:1:6" # NOTE not done
    # "lyr-m-64epts-4topk-1iter-8lyr:64:4:1:8" # NOTE not done
    ...
    # "wid-cm-128epts-16topk-1iter-4lyr:128:16:1:4" # NOTE not done
