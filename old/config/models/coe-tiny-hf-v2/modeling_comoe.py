...
from .configuration_comoe import CoEConfig
...
class CoEMoE(nn.Module):
    ...
    def moe_infer(self, x, topk_ids, topk_weight):
        ...
        if self.ep_size > 1:
            ...
            gatherd_idxs = torch.zeros(shape=(gathered_tokens.shape[0],), dtype=torch.long)
            s = 0
    ...
    def forward(
        ...
        **kwargs,
        ...
        for iter_idx in range(num_iter):
            ...
            hidden_states = self.mlp(hidden_states)
            hidden_states = residual + hidden_states
            # Not implemented, but claude said: residual = hidden_states  # Update for next iter
