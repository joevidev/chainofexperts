...
configs=(
    "fl-64epts-4topk-2iter-4lyr:64:4:2:4"
    "fl-64epts-2topk-4iter-4lyr:64:2:4:4"
    "fl-64epts-1topk-8iter-4lyr:64:1:8:4"
)
    ...
    # "wid-cm-96epts-12topk-1iter-4lyr:96:12:1:4" # NOTE not done
    ...
    # "wid-m-96epts-8topk-1iter-4lyr:96:8:1:4" # NOTE not done
    # "wid-m-128epts-8topk-1iter-4lyr:128:8:1:4" # NOTE not done
